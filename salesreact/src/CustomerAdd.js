...
class CustomerAdd extends Component {
    ...
    constructor(props) {
        super(props);
        this.state = { first_name: '', last_name: '', trading_name_ifbusiness: '', billing_address: '', collection_address_for_returns: '', email: '' };
    ...
    addCustomer(event) {
        ...
        const customer = {
            ...
            trading_name_ifbusiness: data.get("trading_name_ifbusiness"),
            billing_address: data.get("billing_address"),
            collection_address_for_returns: data.get("collection_address_for_returns"),
        ...
        fetch("/customers", {
            ...
            window.location = "CustomerManagement";
        })
    }
                        ...
                        <nav className="navbar navbar-expand-lg navbar-absolute fixed-top navbar-transparent">
                            <div className="container-fluid">
                                <div className="navbar-wrapper">
                                    ...
                                    <a className="navbar-brand" href="#pablo">Create Customer</a>
                                </div>
