...
class CustomerDetailList extends Component{

    constructor(props){
        super(props);
        this.handleUserDetails = this.handleUserDetails.bind(this);
        this.state = {customerId:"", customerDetail: false, customers: []};
    }
    ...
    render() {
        ...
        const customersList = customers!==undefined && customers.map(customer => {
            return (
                <table>
                    <tbody onClick={()=>this.handleUserDetails(customer.id)}>
            ...
            <div>
                {
                    this.state.customerDetail?(
                        <Navigate to={{pathname:"/customerDetail",state:{custId:this.state.customerId}}}/>
                    ):("")
                }
                <meta charSet="utf-8" />
                        ...
                        <nav className="navbar navbar-expand-lg navbar-absolute fixed-top navbar-transparent">
                            <div className="container-fluid">
                                <div className="navbar-wrapper">
                                    ...
                                    <a className="navbar-brand" href="#pablo">Customer Detail List</a>
                                </div>
